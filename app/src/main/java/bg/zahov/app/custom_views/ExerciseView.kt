    ...
    class ExerciseView @JvmOverloads constructor(
        ...
        private fun showPopupWindow(
            ...
            val popupWindow = PopupWindow(popupView, resources.getDimension(R.dimen.popup_width).toInt(), (radioOptions.size * resources.getDimension(R.dimen.popup_min_height).toInt()), true)
